  ...
  "التناقضات": [
    {
      ...
      "مستوى_التعارض": "حاد",
      "تعليق": "إفادة 1 تدعو إلى التنفيذ الفوري للمقترح بينما إفادة 2 ترفض المقترح بسبب عدم وضوح التكلفة والمخاطر."
    },
    {
      "إفادات": [
        "أوصي باعتماد المقترح بشكل كامل والبدء في التنفيذ الفوري، حيث أن المشروع جاهز من الناحية الفنية، وتأخير القرار قد يؤدي إلى خسارة فرص استراتيجية مهمة.",
      ...
      "مستوى_التعارض": "متوسط",
      "تعليق": "إفادة 1 تدعو إلى التنفيذ الفوري الكامل بينما إفادة 3 تقترح تطبيق المقترح على نطاق محدود أولاً."
    },
    {
      "إفادات": [
        "أوصي باعتماد المقترح مع البدء بتطبيقه على نطاق محدود لمدة 3 أشهر لقياس الأثر قبل التوسع الكامل.",
      ...
      "مستوى_التعارض": "متوسط",
      "تعليق": "إفادة 3 تقترح تجربة لمدة 3 أشهر بينما إفادة 4 تقترح تجربة لمدة سنة كاملة."
    }
  ]
}
```
